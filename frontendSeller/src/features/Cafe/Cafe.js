	...
	return (
		<div className="min-h-screen text-black font-Rubik bg-gradient-to-r  from-slate-200 to-slate-500 font-bold">
			...
			<div className="font-Rubik justify-center mr-4 text-zinc-900">
				...
				<button onClick={handleDelete} className="flex justify-center m-auto font-bold font-Rubik w-32 px-5 py-2 transition duration-300 ease-in-out rounded-3xl delay-60 hover:-translate-y-1 hover:scale-110 hover:text-black bg-gradient-to-r from-yellow-200 to-yellow-500 hover:from-red-500 hover:to-red-900">
					Delete Cafe
				</button>
			</div>
			<div></div>
