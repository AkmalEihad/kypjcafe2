			...
			<div className="flex flex-col justify-center items-start m-auto">
				...
				<form action="" className="grid justify-center items-center grid-rows-4 gap-10 drop-shadow-lg" onSubmit={handleSubmit}>
					<div className="relative grid grid-cols-2 gap-4">
						<input id="name" value={seller_name} onChange={handleNameChange} type="text" className="border border-gray-300 w-full py-2 px-3 rounded-md focus:border-black focus:outline-none" required />
						<label
							htmlFor=""
						...
						<div className="relative">
							<input id="username" value={seller_username} onChange={handleUsernameChange} type="text" className="border border-gray-300 w-full py-2 px-3 rounded-md focus:border-black focus:outline-none" required />
							<label
								htmlFor=""
					...
					<div className="relative">
						<input id="password" value={seller_password} onChange={handlePasswordChange} type="password" className="border border-gray-300 w-full py-2 px-3 rounded-md focus:border-black focus:outline-none" required />
						<label
							htmlFor=""
					...
					<div className="relative">
						<input id="email" value={seller_email} onChange={handleEmailChange} type="mail" className="border border-gray-300 w-full py-2 px-3 rounded-md focus:border-black focus:outline-none" required />
						<label
							htmlFor=""
